...
class graph_power_sys():
    ...
    def build_net(self):
        ...
        V1, Seta1 = self.forward_Block(input_V, input_Seta, input_P, input_Q, self.G, self.B, block='a', iteration=4)
        V2, Seta2 = self.forward_Block(V1, Seta1, input_P, input_Q, self.G, self.B, block='b', iteration=4)
        V3, Seta3 = self.forward_Block(V2, Seta2, input_P, input_Q, self.G, self.B, block='output', iteration=4)
    ...
    def forward_Block(self, input_V, input_Seta, input_P, input_Q, G, B, block, iteration=5):
